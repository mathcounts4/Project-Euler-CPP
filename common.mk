...
BAD_WARN  := -Wno-c++98-compat -Wno-c++98-compat-pedantic -Wno-exit-time-destructors -Wno-global-constructors -Wno-padded -Wno-self-assign-overloaded -Wno-unused-lambda-capture -Wno-float-conversion -Wno-float-equal -Wno-poison-system-directories -Wno-switch-enum -Wno-weak-vtables -Wno-switch-default -Wno-ordered-compare-function-pointers -Wno-reserved-identifier
