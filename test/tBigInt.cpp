...
TEST(BigInt,Comparison) {
    ...
    CHECK("34879468572945867495687439586" > big, isTrue());
    CHECK("-9843349435609874564454565587" < big, isTrue());
    CHECK("4358762345876324589763485762485764587645876342857346328457634587456874365" < inf, isTrue());
    CHECK("-4358762345876324589763485762485764587645876342857346328457634587456874365" > -inf, isTrue());
}
